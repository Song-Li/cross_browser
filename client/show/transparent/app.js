                        ...
                        if (modelErr) {
                            ...
                            loadImage(root + 'color.png', function (imgErr, img) {
                                if (imgErr) {
                                    ...
                                    runTransparent(vsText, fsText, img, modelObj, 'transparent_susan');
                                }
                            });
                        }
                    });
                        ...
                        if (modelErr) {
                            ...
                            loadImage(root + 'color.png', function (imgErr, img) {
                                if (imgErr) {
                                    ...
                                    runTransparent(vsText, fsText, img, modelObj, 'transparent_simple');
                                }
                            });
                        }
                    });
...
var runTransparent = function (vertexShaderText, fragmentShaderText, SusanImage, SusanModel, canvasName) {
    var WebGL;
    var gl;
