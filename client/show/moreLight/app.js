var MoreLightTest = function () {
    var RunMoreLight = function (vertexShaderText, fragmentShaderText, SusanImage, SusanModel, canvasName, ID) {
        var WebGL;
        ...
        if(canvasName == 'more_light_susan') mat4.lookAt(viewMatrix, [0, 0, -5], [0, 0, 0], [0, 1, 0]);
        else
                          ...
                          if (modelErr) {
                              ...
                              loadImage(root + 'color.png', function (imgErr, img, self) {
                                  if (imgErr) {
                                      ...
                                      var test = new RunMoreLight(vsText, fsText, img, modelObj, 'more_light_susan', self.IDs[0]);
                                  }
                              }, self);
                          }
                      }, self);
                          ...
                          if (modelErr) {
                              ...
                              loadImage(root + 'color.png', function (imgErr, img, self) {
                                  if (imgErr) {
                                      ...
                                      var test = new RunMoreLight(vsText, fsText, img, modelObj, 'more_light_simple', self.IDs[1]);
                                  }
                              }, self);
                          }
                      }, self);
