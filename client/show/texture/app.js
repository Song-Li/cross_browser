...
var runTexture = function (vertexShaderText, fragmentShaderText, SusanImage, SusanModel, canvasName) {
    var WebGL;
    var gl;
    ...
    if(canvasName == "texture_simple") mat4.lookAt(viewMatrix, [0, 0, -120], [0, 0, 0], [0, 1, 0]);
    else mat4.lookAt(viewMatrix, [0, 0, -5], [0, 0, 0], [0, 1, 0]);
