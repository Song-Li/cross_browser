              ...
              if (modelErr) {
                ...
                loadImage(root + 'color.png', function(imgErr, img, self) {
                  if (imgErr) {
                    ...
                    var test = new RunTexture(vsText, fsText, img, modelObj, 'texture_susan', self.IDs[0]);
                  }
                }, self);
              }
            }, self);
              ...
              if (modelErr) {
                ...
                loadImage(root + 'color.png', function(imgErr, img, self) {
                  if (imgErr) {
                   ...
                   var test = new RunTexture(vsText, fsText, img, modelObj, 'texture_simple', self.IDs[1]);
                  }
                }, self);
              }
            }, self);
