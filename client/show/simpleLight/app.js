var SimpleLightTest = function() {
  var RunSimpleLight = function(vertexShaderText, fragmentShaderText,
                                SusanImage, SusanModel, canvasName, ID) {
    var WebGL;
    var gl;
    ...
    if (canvasName == 'simple_light_susan')
                  ...
                  if (modelErr) {
                    ...
                    loadImage(root + 'color.png', function(imgErr, img, self) {
                      if (imgErr) {
                        ...
                        var test = new RunSimpleLight(
                            vsText, fsText, img, modelObj, 'simple_light_susan',
                            self.IDs[0]);
                      }
                    }, self);
                  }
                    ...
                    loadImage(root + 'color.png', function(imgErr, img, self) {
                      if (imgErr) {
                        ...
                        var test = new RunSimpleLight(
                            ...
                            'simple_light_simple', self.IDs[1]);
                      }
                    }, self);
                  }
                }, self);
