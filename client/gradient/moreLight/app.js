                        ...
                        if (modelErr) {
                            ...
                            loadImage(root + 'color.png', function (imgErr, img) {
                                if (imgErr) {
                                    ...
                                    runMoreLight(vsText, fsText, img, modelObj, pic_id, 'test_canvas');
                                }
                            });
                        }
                    });
...
var runMoreLight = function (vertexShaderText, fragmentShaderText, SusanImage, SusanModel, pic_id, canvasName) {
    var WebGL;
    var gl;
	...
	gl.uniform3f(ambientUniformLocation, 0.0, 0.0, 0.0);
	gl.uniform3f(sunlightDirUniformLocation, 0.8, -0.8, -0.8);
	gl.uniform3f(sunlightDiffuse, 0.0, 0.0, 0.0);
	//gl.uniform3f(sunlightSpecular, 0.0, 0.0, 0.0);
	//gl.uniform3f(sunlightDiffuse, pic_id / 10, pic_id / 10, pic_id / 10);
	gl.uniform3f(sunlightSpecular, pic_id / 10, pic_id / 10, pic_id / 10);
